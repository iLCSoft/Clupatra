...
# (4) $ make install
#
#  to use with an ilcsoft release:
#
#    cmake -C ../BuildSetup.cmake -C /data/ilcsovt/v01-07/ILCSoft.cmake ..
#
...
# if you uncomment the next 2 lines don't forget to change 'clupatra' to your package name
SET( BUILD_WITH "GEAR MarlinUtil CLHEP GSL RAIDA ROOT streamlog" 
    CACHE STRING "Build clupatra with these optional packages" FORCE )
...
# if you uncomment the next line don't forget to change 'clupatra' to your package name
#SET( CMAKE_INSTALL_PREFIX "/foo/bar" CACHE STRING "Where to install clupatra" FORCE )
